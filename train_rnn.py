...
parser.add_option("-i","--epochinterval",type="int",dest="epochinterval", help="interval of epochs to print on", default=5)
...
U,V,W = model.rnn_sgd(Xtrain,Ytrain,epochs=options.numepochs,loss_epoch=options.epochinterval)
